...
namespace SupaSpeedGrader.API
{
    public class clsHttpMethods : clsRegEx
    {
        ...
        public static async Task<HttpResponseMessage> httpGET(string baseUrl, string urlCommand, string accessToken)
        {
        ...
        /// <returns>http response from api endpoint</returns>
        public static async Task<HttpResponseMessage> httpPOST(string baseUrl, string urlCommand, string accessToken, HttpContent content)
        {
            HttpResponseMessage response = null;
        ...
        /// <param name="content">can be used to pass parameters in the body</param>
        /// <returns>http response from api endpoint</returns>
        public static async Task<HttpResponseMessage> httpPUT(string baseUrl, string urlCommand, string accessToken, HttpContent content)
        {
            HttpResponseMessage response = null;
        ...
        /// <returns></returns>
        public static string concatenateHttpVars(string urlCommand, Dictionary<string, string> vars)
        {
